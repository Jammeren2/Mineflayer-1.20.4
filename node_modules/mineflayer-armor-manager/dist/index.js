...
const initializeBot = (bot) => {
    ...
    bot.armorManager = {
        equipAll: () => __awaiter(void 0, void 0, void 0, function* () {
            for (const item of bot.inventory.items()) {
                yield (0, equipItem_1.equipItem)(bot, item.type);
            }
        }),
    };
    bot.on("playerCollect", (collector, collected) => {
        ...
        if (item != null && (0, isArmor_1.isArmor)(item)) {
            // Little delay to receive inventory
            setTimeout(() => (0, equipItem_1.equipItem)(bot, item.type), 100);
        }
    });
};
